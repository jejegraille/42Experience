...
/*   Updated: 2017/05/27 12:19:25 by jgraille         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_putstrtab(char **tabl, char separator);
void				ft_putstrtab_fd(char **tabl, char separator, int fd);
...
char				**ft_tabsdup(char **tabl);
void				ft_deltabs(char **tabl);
void				ft_pushtabs(char ***tabl, char *str);
void				ft_remtabs(char ***tabl, size_t index);
void				ft_log(char *str, char *separator);
double				ft_rand(void);
void				ft_sorttabi(int *tabl, int len, int dec);
void				ft_put_memory(const void *addr, size_t size);
int					ft_itoa_s(char *str, int nbr);
int					ft_check_brackets(char *line);
